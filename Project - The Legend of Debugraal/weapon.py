...
class Weapon(pygame.sprite.Sprite):
    def __init__(self, player, groups):
        ...
        if direction == 'right':
            ...
            self.rect = self.image.get_rect(midtop = player.rect.midbottom + pygame.math.Vector2(-35, -40))
        else:
            self.rect = self.image.get_rect(midbottom = player.rect.midtop + pygame.math.Vector2(-35, 43))